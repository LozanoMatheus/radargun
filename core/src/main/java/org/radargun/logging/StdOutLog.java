...
public class StdOutLog implements Log {
   ...
   public void info(String message) {
      System.out.printf("INFO\t[%s] (%s) %s\n", className, Thread.currentThread().getName(), message);
   }
   ...
   public void infof(String format, Object... args) {
      System.out.printf("INFO\t[%s] (%s) " + format + "\n", prefix(args));
   }
   ...
   public void warnf(String format, Object... args) {
      System.out.printf("WARN\t[%s] (%s) " + format + "\n", prefix(args));
   }
   ...
   public void errorf(String format, Object... args) {
      System.out.printf("ERROR\t[%s] (%s) " + format + "\n", prefix(args));
   }
   ...
   public void fatalf(String format, Object... args) {
      System.out.printf("FATAL\t[%s] (%s) " + format + "\n", prefix(args));
   }
   ...
   private Object[] prefix(Object[] args) {
      return new Object[]{ className, Thread.currentThread().getName(), args};
   }
